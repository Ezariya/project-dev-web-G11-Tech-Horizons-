        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                    <x-nav-link :href="route('history.manage')" :active="request()->routeIs('history.manage')">
                        {{ __('history manage') }}
                    </x-nav-link>
                    @endauth
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    @if($userRole === 'responsable')
                        <x-nav-link :href="route('responsable.dashboard')" :active="request()->routeIs('responsable.dashboard')">
                            {{ __('responsable') }}
                        </x-nav-link>
                    @endif
